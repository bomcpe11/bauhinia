...
<div class="wrapper">
    ...
    <div class="banner">
        <ul class="bxslider">
          <li><img src="<?php echo get_template_directory_uri(); ?>/images/banner1.jpg" alt=""></li>
          <li><img src="<?php echo get_template_directory_uri(); ?>/images/banner2.jpg" alt=""></li>
          <li><img src="<?php echo get_template_directory_uri(); ?>/images/banner3.jpg" alt=""></li>
          <li><img src="<?php echo get_template_directory_uri(); ?>/images/banner4.jpg" alt=""></li>
        </ul>
        ...
        <section class="gray-bg">
        	<div class="container">
                ...
                <div id="owl-carousel" class="owl-carousel owl-theme">
                    ...
                    <div class="course">
                    	<div class="thumb">
                        	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/course1.jpg" alt=""></a>
                    ...
                    <div class="course">
                    	<div class="thumb">
                        	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/course2.jpg" alt=""></a>
                    ...
                    <div class="course">
                    	<div class="thumb">
                        	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/course3.jpg" alt=""></a>
                    ...
                    <div class="course">
                    	<div class="thumb">
                        	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/course4.jpg" alt=""></a>
        ...
        <section class="form">
        	<div class="form-contant relative">
            	<div class="container form-fields"> 
                	<div class="row">
                    	<div class="span6">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student.png" alt="">
                        </div>
                        <div class="span6">
                ...
                <div class="tab-content container">
                  <div id="web" class="tab-pane fade active in">
                    <ul class="course-topics row">
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic1.jpg" alt=""></a>
                            </div>
                            <div class="text">
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic2.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h4>HTML5 Programming</h4>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic3.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h4>HTML5 Programming</h4>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic4.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h4>HTML5 Programming</h4>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic5.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h4>HTML5 Programming</h4>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                    	...
                    	<li class="span4">
                        	<div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/topic6.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h4>HTML5 Programming</h4>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem</p>
                ...
                <div class="row">
                	...
                	<div class="span3">
                    	<div class="teachers">
                            ...
                            <div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/teachers2.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h2><a href="#">Mickey Rorey</a></h2>
                                <p>Science Teacher</p>
                	...
                	<div class="span3">
                    	<div class="teachers">
                            ...
                            <div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/teachers3.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h2><a href="#">Mickey Rorey</a></h2>
                                <p>Science Teacher</p>
                	...
                	<div class="span3">
                    	<div class="teachers">
                            ...
                            <div class="thumb">
                            	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/teachers4.jpg" alt=""></a>
                            </div>
                            <div class="text">
                            	<h2><a href="#">Mickey Rorey</a></h2>
                                <p>Science Teacher</p>
        ...
        <section class="papular-post">
            ...
            <div class="container post-contant">
            	...
            	<div class="row">
                	<div class="span6">
                    	<div class="post">
                        	<div class="thumb"><img src="<?php echo get_template_directory_uri(); ?>/images/post.png" alt=""></div>
                            <!--POST HEADER START-->
                            <div class="header">
                                <!--POST DATE START-->
                                <div class="post-date">
                	...
                	<div class="span4">
                    	<div class="box">
                            ...
                            <ul class="event-galley">
                            	...
                            	<li>
                                    <div class="thumb">
                                        <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/event1.png"></a>
                                    </div>
                                    <div class="text">
                                        <p>21-04-2012</p>
                            	...
                            	<li>
                                    <div class="thumb">
                                        <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/event2.png"></a>
                                    </div>
                                    <div class="text">
                                        <p>21-04-2012</p>
                                        <h4>most popular courses </h4>
                            	...
                            	<li>
                                    <div class="thumb">
                                        <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/event3.png"></a>
                                    </div>
                                    <div class="text">
                                        <p>21-04-2012</p>
                                        <h4>most popular courses </h4>
                            	...
                            	<li>
                                    <div class="thumb">
                                        <a href="#"><img alt="" src="<?php echo get_template_directory_uri(); ?>/images/event4.png"></a>
                                    </div>
                                    <div class="text">
                                        <p>21-04-2012</p>
                                        <h4>most popular courses </h4>
        	...
        	<div class="container testimonial-contant">
                ...
                <div id="bx-pager">
                    <a data-slide-index="0" href="">
                    	<div class="thumb">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student-testi1.jpg" alt="">
                        </div>
                        <p>Naiana Ansa</p>
                    ...
                    <a data-slide-index="1" href="">
                    	<div class="thumb">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student-testi2.jpg" alt="">
                        </div>
                        <p>Jasmine Dou</p>
                    ...
                    <a data-slide-index="2" href="">
                    	<div class="thumb">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student-testi3.jpg" alt="">
                        </div>
                        <p>David john</p>
                        <p class="color">student</p>
                    </a>
                    <a data-slide-index="3" href="">
                    	<div class="thumb">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student-testi4.jpg" alt="">
                        </div>
                        <p>Roth Brown</p>
                    ...
                    <a data-slide-index="4" href="">
                    	<div class="thumb">
                        	<img src="<?php echo get_template_directory_uri(); ?>/images/student-testi5.jpg" alt="">
                        </div>
                        <p>Timothy Smith</p>
                ...
                <div class="side-imgage"><img src="<?php echo get_template_directory_uri(); ?>/images/testimonials-bg2.png" alt=""></div>
            </div>
                ...
                <div class="span3">
                	<div class="widget widget-article">
                        ...
                        <ul class="bxslider">
                            <li>
                            	<div class="thumb">
                            		<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/article.jpg" alt=""></a>
                                </div>
                                <div class="text">
				...
				<div class="span3">
                	<div class="widget widget-top-rated">
						...
						<ul>
							<li>
                            	<div class="thumb">
                                	<a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/toprated.jpg" alt=""></a>
                                </div>
                                <div class="text">
                ...
                <!--OUR ARTICLE WIDGET START-->
                    ...
                    <div class="span3">
                        <div class="widget widget-facebook">
                            <h2>Fcebook</h2>
                            <div class="pull-left">
                            	<img src="<?php echo get_template_directory_uri(); ?>/images/facebook-widget.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <!--TOP RATED WIDGET END-->
